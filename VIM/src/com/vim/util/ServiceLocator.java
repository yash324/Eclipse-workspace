...
public class ServiceLocator {
	...
	/**
	 * Making the default (no arg) constructor private ensures that this class
	...
	public static DataSource getDataSource(String dataSourceJndiName) throws ServiceLocatorException {
		...
		try {
			...
			// TODO 5 wrap ClassCastException in ServiceLocatorException and
			// throw
